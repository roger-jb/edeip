...
<div id='angle_rond'>
	...
	if ($form) {
		...
		<div class='corps'>
			...
			<a class="mapgen-link"
			   style="font:8px Arial;text-decoration:none;color:#5C5C5C;text-align: right; display: block; width: 700px;"
			   href="http://map-generator.net/fr">map-generator.net</a>
			...
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" ENCTYPE="multipart/form-data">
				<table>
					...
					<tr>
						<td><input type="text" required name="nom" value="<?php echo $nom; ?>" required/></td>
					</tr>
					<tr>
						<td><strong>E-Mail * :</strong></td>
					</tr>
					<tr>
						<td><input type="email" required name="mail" value="<?php echo $mail; ?>" required/></td>
					</tr>
					<tr>
					...
					<tr>
						<td><strong>Votre demande * :</strong></td>
					</tr>
					<tr>
						<td>
							<input type="checkbox" name="demande"
							       value="J’envisage d’inscrire mon (mes) enfant(s) à l’EDEIP Lyon à la prochaine rentrée scolaire"/>J’envisage
							d’inscrire mon (mes) enfant(s) à l’EDEIP Lyon à la prochaine rentrée scolaire<br/>
							<input type="checkbox" name="demande"
							       value="Je souhaite être contacté(e) pour plus d’informations"/>Je souhaite être
							contacté(e) pour plus d’informations<br/>
							<input type="checkbox" name="demande"
							       value="Je propose mes compétences pour renforcer l’équipe"/>Je propose mes
							compétences pour renforcer l’équipe<br/>
						</td>
					</tr>
					<tr>
