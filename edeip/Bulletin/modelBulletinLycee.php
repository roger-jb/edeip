...
<page backtop="30mm" backbottom="7mm" backleft="10mm" backright="10mm">
	...
	<table cellspacing="0" style="border: solid 2px #000000; width: 100%;" class="tableau">
		...
		<tr>
			...
			<td style="text-align: center;">
				<?php
				echo Bulletin::getMoyenneByEleveTrimestreMatiere($eleve->getIdEleve(), $trimestre->getIdTrimestre(), 8);
				?>
			</td>
			<td>
				<?php
		...
		<tr>
			...
			<td style="text-align: center;">
				<?php
				echo Bulletin::getMoyenneByEleveTrimestreMatiere($eleve->getIdEleve(), $trimestre->getIdTrimestre(), 3);
				?>
			</td>
			<td>
				<?php
		...
		<tr>
			<td>Science<br>&Eacute;conomiques <br>et Sociales<br></td>
			<td style="text-align: center;">
				<?php
				echo Bulletin::getMoyenneByEleveTrimestreMatiere($eleve->getIdEleve(), $trimestre->getIdTrimestre(), 14);
				?>
			</td>
			<td>
				<?php
				$bulletins =  Bulletin::getByEleveTrimestreMatiere($eleve->getIdEleve(), $trimestre->getIdTrimestre(), 14);
				foreach($bulletins as $bulletin){
					echo str_replace("\n", "<br>", $bulletin->getContenuBulletin()).'<br>';
				}
				?>
