        ...
        <div id="corps">
            ...
            <fieldset>
                ...
                <table>
					...
					<tr>
						...
						$noteCpt = 0;
						while ($noteCpt < $nbCpt) {
							echo "<td><input type='button' class='submit evalCpt' id='evalCpt".($noteCpt+1)."' value='entrer / modifier'/></td>";
							$noteCpt++;
						}
						?>
					</tr>
			...
			<fieldset>
				...
				foreach ($eleves as $eleve){
					echo '<tr>';
					// nom de l'eleve
					echo '<td>'.$eleve->getLibelleUtilisatur().'</td>';
					...
					foreach ($evalCpt as $eCpt) {
						...
						if (!is_null($elevePointCpt->getIdNiveauCpt()))
							echo '<td>'.$elevePointCpt->getNiveauCpt()->getCodeNiveauCpt().'</td>';
						else
							echo '<td></td>';
					}
					$nbCpt--;
