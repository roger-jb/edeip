...
class Matiere {
	...
	public function insert () {
		$query = "INSERT INTO MATIERE (libelleMatiere) VALUES (" . "'" . db_connect::escape_string($this->getLibelleMatiere()) . "' " . ")";
		if (db_connect::query($query)) {
			$select = "SELECT idMatiere FROM MATIERE WHERE " . "libelleMatiere = '" . db_connect::escape_string($this->getLibelleMatiere()) . "'";
	...
	public function update () {
		$query = "UPDATE MATIERE SET " . "libelleMatiere = '" . db_connect::escape_string($this->getLibelleMatiere()) . "'
